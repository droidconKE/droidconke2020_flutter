...
class _$SpeakerCopyWithImpl<$Res> implements $SpeakerCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object blog = freezed,
    Object company_website = freezed,
  }) {
    return _then(_value.copyWith(
      ...
      linkedin: linkedin == freezed ? _value.linkedin : linkedin as String,
      instagram: instagram == freezed ? _value.instagram : instagram as String,
      blog: blog == freezed ? _value.blog : blog as String,
      company_website: company_website == freezed
          ? _value.company_website
...
class _$_Speaker implements _Speaker {
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _Speaker &&
            ...
            (identical(other.company_website, company_website) ||
                const DeepCollectionEquality()
                    .equals(other.company_website, company_website)));
  }
  ...
  int get hashCode =>
      ...
      const DeepCollectionEquality().hash(company_website);
